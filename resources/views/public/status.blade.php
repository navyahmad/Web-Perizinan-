                ...
                <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-slate-50/50">
                    ...
                    <div>
                        ...
                        @elseif($statusData['status'] === 'rejected')
                            <span class="inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-bold bg-rose-100 text-rose-800 border border-rose-300">
                        ...
                        @else
                            <span class="inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-bold bg-amber-100 text-amber-800 border border-amber-300">
                                <svg class="w-4 h-4 mr-1.5 text-amber-600 animate-spin" fill="none" viewBox="0 0 24 24">
                    ...
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                        ...
                        @if($statusData['duration'])
                            <div>
                                ...
                                <dd class="mt-1 font-medium text-slate-900">
                                    {{ $statusData['duration'] }} {{ $statusData['type_label'] === 'Izin Setengah Hari' ? 'Jam' : 'Hari' }}
                                </dd>
                            </div>
                        @endif
