...
<body class="min-h-full flex flex-col text-slate-800 antialiased font-sans bg-slate-50">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('public.form') }}" class="flex items-center space-x-3 group">
                        <div class="w-10 h-10 rounded-lg bg-indigo-600 flex items-center justify-center text-white shadow-xs group-hover:bg-indigo-700 transition">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                        </div>
                        <div>
                            <span class="text-lg font-bold text-slate-900 tracking-tight block leading-tight">Izin Kantor</span>
                            <span class="text-xs text-slate-700 block">General Solusindo & Tabinaco</span>
                        </div>
                    </a>
                </div>
    ...
    <footer class="bg-white border-t border-slate-200 py-6 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 space-y-2 sm:space-y-0">
            <div>
                &copy; {{ date('Y') }} <strong>Website CRUD Izin Kantor</strong> &bull; General Solusindo & Tabinaco
            </div>
